...
pub struct WsMessageActor<C, AckMode> {
    client_id: ClientId,
...
/// `ExecutionActor`
struct ExecutionBroker<AckMode> {
    client_id: ClientId,
...
impl ExecutionBroker<AckModeNone> {
...
impl<AckMode: Unpin + 'static> Actor for ExecutionBroker<AckMode> {
