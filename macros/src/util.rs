...
#[cfg(feature = "server")]
pub(crate) fn transform_method(f: &mut syn::ImplItemMethod) {
...
#[cfg(feature = "client")]
pub(crate) fn generate_client_stub(
    ident: &syn::Ident,
    input: syn::ItemImpl,
...
#[cfg(feature = "client")]
pub(crate) fn generate_client_stub_method(
    service_ident: &syn::Ident,
...
#[cfg(feature = "client")]
pub(crate) fn generate_client_stub_method_impl(
    service_ident: &syn::Ident,
    fn_ident: &syn::Ident,
    req_ty: &syn::Type,
...
#[cfg(any(feature = "server", feature = "client"))]
pub(crate) fn filter_exported_methods(input: syn::ItemImpl) -> syn::ItemImpl {
